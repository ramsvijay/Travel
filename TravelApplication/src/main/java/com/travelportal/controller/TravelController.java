...
public class TravelController 
{
    ...
    @ResponseBody 
    public String login(@PathVariable String email,@PathVariable String password,HttpSession session) {
    System.out.println("controll");
     String employee = travelservice.login(email,password);
    ...
    public @ResponseBody
    BusBook busbook(@RequestBody BusBook busbook) {
    ...
    public @ResponseBody
    FlightBook flightbook(@RequestBody FlightBook flightbook) {
