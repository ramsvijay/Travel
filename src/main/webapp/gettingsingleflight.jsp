...
<tr>
<td class="text-left">TRAVEL NAME</td>
<td class="text-left" id="travel"></td>
</tr>
<tr>
...
<tr>
<td class="text-left">DEPARTURE DETAILS</td>
<td class="text-left" id="ddetail"></td>
</tr>
<tr>
<td class="text-left">ARRIVAL DETAILS</td>
<td class="text-left" id="adetail"></td>
</tr>
<tr>
...
$( document ).ready(function() { 
	...
	$('#travel').text(travel);
	var type=sessionStorage.getItem("source");
	$('#source').text(type);
	var dp=sessionStorage.getItem("dtime");
	$('#dtime').text(dp);
	...
	$('#nop').text(ss);
	var dd=sessionStorage.getItem("ddetail");
	$('#ddetail').text(dd);
	var ad=sessionStorage.getItem("adetail");
	$('#adetail').text(ad);
	var ga=sessionStorage.getItem("fare");
	$('#fare').text(ga);
